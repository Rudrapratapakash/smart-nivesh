...
function App() {
  ...
  return (
    <HelmetProvider>
      <div className="App">
        <Helmet>
          <title>SIP Calculator | Smart Nivesh</title>
          <meta
            name="description"
            content="Calculate your SIP returns instantly with Smart Nivesh."
          />
        </Helmet>
        <div className="App">
            ...
            <div className="result-Box" id="result-Box">
              ...
              <div className="result-row total-amount">
                ...
                <span id="displayTotal">
                  {formatCurrency(
                    adjustInflation ? result.adjTotal : result.total,
                  )}
                </span>
              </div>
            </div>
          ...
          <div class="content-section">
            ...
            <p>
              Welcome to India's fastest <strong>SIP Calculator</strong>. If you
              are planning to invest in Mutual Funds, our free tool helps you
              estimate how much wealth you can create over time.
            </p>

            <h3>What is a Systematic Investment Plan (SIP)?</h3>
            <p>
              A Systematic Investment Plan (SIP) is a method of investing in
              mutual funds where an investor chooses to invest a fixed amount of
              money at regular intervals (usually monthly). It is one of the
              best ways to build wealth for long-term goals like buying a house,
            ...
            <ul>
              <li>
                <strong>Instant Results:</strong> No manual calculations needed.
                Get results in milliseconds.
              </li>
              <li>
                <strong>Inflation Planning:</strong> Helps you understand the
                future value of your money.
              </li>
              <li>
                <strong>Goal Setting:</strong> Decide how much you need to
                invest monthly to reach 1 Crore or more.
              </li>
            </ul>

            <h3>How is SIP Calculated?</h3>
            <p>
              SIP returns are calculated based on compound interest. The longer
              you stay invested, the more your money grows. The formula used is:
            </p>
          ...
          <div class="content-section faq-container">
            ...
            <div class="faq-item">
              ...
              <p>
                Yes! Many top mutual funds in India allow you to start a SIP
                with as low as <strong>₹500 or even ₹100 per month</strong>. You
                don't need a large amount to start building wealth.
              </p>
            </div>
            ...
            <div class="faq-item">
              ...
              <p>
                Yes, open-ended mutual funds offer high liquidity. You can
                withdraw your money anytime with a click of a button. However,
            ...
            <div class="faq-item">
              ...
              <p>
                ...
                <strong>ELSS (Equity Linked Savings Scheme)</strong>, you can
                save tax up to ₹1.5 Lakh under Section 80C of the Income Tax
                Act.
              </p>
            </div>
            ...
            <div class="faq-item">
              ...
              <p>
                Fixed Deposits (FD) usually offer 6-7% returns, while SIPs in
                Equity Mutual Funds can offer <strong>12-15% returns</strong>{" "}
                over the long term. SIP beats inflation better than FD.
              </p>
            </div>
          </div>
        </div>
